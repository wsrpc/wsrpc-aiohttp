...
# -*- coding: utf-8 -*-
#
# wsrpc-aiohttp documentation build configuration file, created by
...
raw_version = metadata.version("wsrpc-aiohttp")
...
html_title = "WSRPC is the RPC over WebSocket for aiohttp"
